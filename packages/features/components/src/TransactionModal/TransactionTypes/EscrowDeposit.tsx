...
const EscrowDeposit = (props) => {
  ...
  //token
  var dep_token = props.data.token;
  //token specs
  var canister = dep_token.canister_string;
  var fee = dep_token.fee;
  var sym = dep_token.symbol;
  var decimals = dep_token.decimal;
  var standard = dep_token.standard;
  //token id
