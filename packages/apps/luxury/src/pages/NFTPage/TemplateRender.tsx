    ...
    switch (tempObj.type) {
      ...
      case 'mainPhoto':
        return <Flex align="center" justify="center" flexFlow="column">
          ...
          <MainImage src={data?.b2bCanisterId ? `https://canister-storage-development.s3.amazonaws.com/${data.canisterId}/tokens/${data.tokenId}/library/${data[tempObj.pointer][0].path}` : `https://${data.canisterId}.raw.ic0.app/-/${data.tokenId}/-/${data[tempObj.pointer][0].path}`} alt='' />
        </Flex>
      case 'section':
