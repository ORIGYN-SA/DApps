  ...
  const fetchData = () => {
    ...
    if (actor) {
      ...
      actor?.collection_nft_origyn([]).then((response) => {
        ...
        Promise.all(
          response?.ok?.token_ids[0]?.map((nft) => {
      ...
      <div>
        ...
        >
          <Grid
            ...
            xs={12}
            md={3}
            sx={{ borderRight: '1px solid #aaaaaa' }}
          >
            <List sx={{ width: '100%' }}>
          ...
          <Grid item xs={12} md={9} sx={{ padding: '10px' }}>
            ...
            <Grid container spacing={2}>
              {filteredNFTs?.map((nft) => {
                const nftID = nft.metadata.Class.find(
                  ({ name }) => name === 'id'
                ).value.Text
                return (
                      ...
                      <Card variant="outlined">
                        ...
                        <CardContent>
                          ...
                          <Typography>
                            ...
                            <SymbolWithIcon
                              symbol={
                                nft?.current_sale[0]?.sale_type?.auction?.config
                          ...
                          <Typography>
                            ...
                            <strong>
                              <NatPrice
                                value={
                                  nft?.current_sale[0]?.sale_type?.auction
                                    ?.config?.auction?.start_price
                                }
                              />
                            </strong>
                          </Typography>
                          <Typography>
                            ...
                            <strong>
                              <NatPrice
                                value={
                                  nft?.current_sale[0]?.sale_type?.auction
                                    ?.config?.auction?.min_increase?.amount
                                }
                              />
                            </strong>
                          </Typography>
