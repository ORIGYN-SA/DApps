    ...
    switch (tempObj.type) {
      ...
      case 'mainPhoto':
        return <Flex align="center" justify="center" flexFlow="column">
          ...
          {console.log()}
          <MainImage src={`https://q7abh-kaaaa-aaaaj-qazva-cai.raw.ic0.app/-/${data.tokenId}/-/${data[tempObj.pointer][0].path}`} alt='' />
        </Flex>
      case 'section':
      ...
      case 'image':
        ...
        return <>
          <img src={`https://q7abh-kaaaa-aaaaj-qazva-cai.raw.ic0.app/-/${data.tokenId}/-/${data[tempObj.pointer][0].path}`} alt='' />
        </>
      case 'gallery':
            ...
            {data[tempObj.pointer].map((img) => {
              return (
                <img
                  ...
                  src={`https://q7abh-kaaaa-aaaaj-qazva-cai.raw.ic0.app/-/${data.tokenId}/-/${img.path}`}
                  alt=""
                />
              );
            })}
          ...
          {data[tempObj.pointer].map((doc) => (
            <>
              <Flex align="center" justify="space-between">
                ...
                <a href={`https://q7abh-kaaaa-aaaaj-qazva-cai.raw.ic0.app/-/${data.tokenId}/-/${doc.path}`}>
