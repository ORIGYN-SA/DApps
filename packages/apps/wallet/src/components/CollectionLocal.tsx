    ...
    <>
      <MainBox>
        ...
        <MainSection>
          ...
          <Stats>
            <MainSection>
              <span style={{ paddingRight: '48px', color: 'white', fontWeight: '600' }}></span>
          ...
          <span>
            ...
            dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat niam, quis
