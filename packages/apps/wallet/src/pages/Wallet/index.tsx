    ...
    <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <g clip-path='url(#clip0_2183_6405)'>
        ...
        <path fill-rule='evenodd' clip-rule='evenodd'
              d='M13.3896 6.49023H5.69043V10.0993H13.3896V17.7985H16.9987V10.0993V6.49023H13.3896Z' fill='white' />
        <path fill-rule='evenodd' clip-rule='evenodd'
              d='M5.20863 21.6002H12.9078V17.9912H5.20863V10.292H1.59961V17.9912V21.6002H5.20863Z' fill='white' />
      </g>
      <defs>
  ...
  const fetchData = () => {
    if (actor && principal) {
      ...
      actor?.balance_of_nft_origyn({ principal }).then((response) => {
        ...
        actor?.nft_batch_origyn(response?.ok?.nfts)
          .then((r) => {
            if ('err' in r)
              throw new Error()
                      ...
                      <Flex align='flex-start' gap={24}>
                        ...
                        <Flex flexFlow='column' fullWidth justify='space-between' gap={8}>
                          ...
                          <Flex flexFlow='row' align='center' fullWidth justify='space-between' smFlexFlow='column'>
                            ...
                            <Flex style={{ flexWrap: 'wrap', marginTop: '8px', alignContent: 'flex-end' }}
                                  gap={8}>{collectionData?.social_links?.thawed?.map((links, index) => (
                              <SocialMediaButton as='a' iconButton
                                                 target="_blank"
                                                 href={links?.Class?.find(({ name }) => name === 'url')?.value?.Text}
                                                 key={index}>
                                {{
                                  'twitter': <TwitterSVG />,
                                  'discord': <DiscordSVG />,
                                ...
                                <Link to={`/${nft.id.nftID}`} key={nft.id.nftID}>
                                  <Card flexFlow='column' style={{ overflow: 'hidden', height: '100%' }}>
                                    ...
                                    <Container style={{ height: '100%' }} size='full' padding='16px'>
                                      <Flex style={{ height: '100%' }} justify='space-between' flexFlow='column'
                                            gap={32}>
                                        <div>
