...
const WalletPage = () => {
  ...
  const { tokenId, canisterId, localDevelopment } = useSessionContext();
        ...
        <img
          src={
            ...
            isLocal() && localDevelopment
              ? `http://${canisterId}.localhost:8000/-/${rows.raw_id}/preview`
              : `https://${canisterId}.raw.ic0.app/-/${rows.raw_id}/preview`
          }
