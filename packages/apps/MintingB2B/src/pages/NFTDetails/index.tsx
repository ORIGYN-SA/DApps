...
const WalletPage = () => {
  ...
  const fetchData = async () => {
    const response = await fetch(`http://localhost:3000/canister/v0/nft-token/${nft_id}`, {
  ...
  const generateQR = async () => {
    const response = await fetch(`http://localhost:3000/canister/v0/token`, {
                  ...
                  <Container size="md" padding="80px" mdPadding="16px">
                    <Grid columns={2} mdColumns={2} gap={120} smGap={16} mdGap={40}>
                      ...
                      <Flex flexFlow="column" gap={8}>
                        ...
                        <br />
                        <Button onClick={generateQR} btnType="filled">
                          Generate QR
                        </Button>
                        <br />
                        <Button
                          ...
                          btnType="filled"
                          disabled={nftData.status !== 'WAITING_FOR_OWNER'}
                        >
                          Connect with QR
                        </Button>
                      </Flex>
