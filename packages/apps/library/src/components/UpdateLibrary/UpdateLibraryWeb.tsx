...
// mint.js
import { OrigynClient, updateLibraryMetadata, getNftCollectionMeta } from '@origyn-sa/mintjs';
...
console.log(metadata);
  const handleSubmit = async () => {
    ...
    try {
      ...
      const updateResponse = await updateLibraryMetadata(tokenId, libraryId,{title: typedTitle, location: typedTitle, read: selectedRead} );
