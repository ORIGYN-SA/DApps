export const APP_MODE = process.env.MODE
export const GLD_NFT_1G_CANISTER_ID = process.env.PUBLIC_GLD_NFT_1G_CANISTER_ID
export const GLD_NFT_10G_CANISTER_ID = process.env.PUBLIC_GLD_NFT_10G_CANISTER_ID
export const GLD_NFT_100G_CANISTER_ID = process.env.PUBLIC_GLD_NFT_100G_CANISTER_ID
export const GLD_NFT_1000G_CANISTER_ID = process.env.PUBLIC_GLD_NFT_1000G_CANISTER_ID
export const SWAP_CANISTER_ID = process.env.PUBLIC_SWAP_CANISTER_ID
export const OGY_LEDGER_CANISTER_ID = process.env.PUBLIC_OGY_LEDGER_CANISTER_ID
export const GLDT_LEDGER_CANISTER_ID = process.env.PUBLIC_GLDT_LEDGER_CANISTER_ID
export const ICP_LEDGER_CANISTER_ID = process.env.PUBLIC_ICP_LEDGER_CANISTER_ID
export const CKUSDC_LEDGER_CANISTER_ID = process.env.PUBLIC_CKUSDC_LEDGER_CANISTER_ID
export const LOGO_CANISTER_ID = process.env.PUBLIC_LOGO_CANISTER_ID
export const ICPSWAP_TOKENS_CANISTER_ID = process.env.PUBLIC_ICPSWAP_TOKENS_CANISTER_ID
export const COLLECTIONS_INDEX_CANISTER_ID = process.env.PUBLIC_COLLECTIONS_INDEX
