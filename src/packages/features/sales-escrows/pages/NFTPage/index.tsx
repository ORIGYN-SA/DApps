              ...
              <Flex fullWidth flexFlow="column">
                {isLoading ? (
                  ...
                  <Flex flexFlow="column">
                              ...
                              {principalId && (
                                <Flex gap={8} flexFlow="column">
                                  {odc?.auctionOpen ? (
                                    <>
                                      ...
                                      {isOwner ? (
                                        ...
                                        odc.auctionNotStarted ? (
                                          <Button onClick={handleClickOpenEsc} disabled={inProcess}>
                                            Cancel Sale
                                          </Button>
                                        ) : (
                                    ...
                                    <Button onClick={onAuctionModalOpen} disabled={inProcess}>
                                      Start an Auction
                                    </Button>
                                  ) : (
                                    <OffersPanel
                    ...
                    <Banner bgColor="PRIMARY_1000" style={{ display: 'block' }}>
                      <TabContent
                        fullWidth
                        tabs={[
