...
const ConnectWallet = () => {
  ...
  const accountDisplay = (
    <div className='pl-1 pr-4 bg-[#f9fafe] rounded-[100px] h-12 border border-[#e9eaf1] justify-between items-center inline-flex'>
  ...
  return isConnected ? (
    ...
    <button
      ...
      className='bg-charcoal text-white px-5 text-center text-sm font-semibold leading-[48px] rounded-full hover:scale-105 duration-100 transition-all'
    >
      {isConnecting ? (
