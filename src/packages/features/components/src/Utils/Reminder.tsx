...
const Reminder: React.FC = () => (
  <div className='self-stretch justify-start items-start gap-2 inline-flex mt-6'>
    <div className='w-[18px] h-[18px] relative'>
      <div className='w-[18px] h-[18px] left-0 top-0 absolute bg-[#e1e1e1] rounded-full' />
      <div className='w-[18px] left-0 absolute text-center text-[#69737c] text-[13px] font-bold'>
        i
      </div>
    </div>
