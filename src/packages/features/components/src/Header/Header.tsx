      ...
      <div className='md:hidden items-center justify-end'>
        {isConnected ? (
          ...
          <button
            ...
            className='bg-charcoal text-white px-5 py-3 text-center text-sm font-semibold rounded-full hover:scale-105 transition-transform duration-100'
          >
            {isConnecting ? 'Connecting...' : 'Connexion'}
          </button>
        )}
        <MobileMenu
          isOpen={isOpen}
