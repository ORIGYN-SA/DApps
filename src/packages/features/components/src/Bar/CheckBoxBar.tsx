...
const CheckboxBar: React.FC<CheckboxBarProps> = ({ items, toggleCheckbox }) => {
  ...
  const uniqueItems = items.filter(
    (item, index) => items.findIndex(t => t.category_name === item.category_name) === index,
  )
  ...
  return (
    <div className='relative w-full mx-auto' ref={dropdownRef}>
      <div
        ...
        } border-gray-300 p-3 px-4 w-full h-[50px] cursor-pointer flex justify-between items-center`}
      >
        {buttonText}
        <span
