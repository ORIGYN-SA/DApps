...
const UserNFTPageSkeleton: React.FC = () => (
  <div className='flex flex-col md:flex-row bg-white rounded-2xl mx-auto border border-[#e1e1e1] xl:max-w-5xl w-full 4xl:max-w-7xl md:min-w-[1128px]'>
    <div className='md:w-[562px] h-[564px] bg-gray-200 animate-pulse rounded-tl-2xl rounded-bl-2xl w-full'></div>
