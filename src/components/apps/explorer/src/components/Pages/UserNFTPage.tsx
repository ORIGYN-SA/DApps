...
import { useGetNFTDetails, useCancelNFTSale } from '@dapp/common-hooks'
import { NFT } from '@dapp/common-types'
import { useAuth } from '@dapp/features-authentication'
import { ConnectWallet, Banner, Toast } from '@dapp/features-components'
...
const UserNFTPage: React.FC = () => {
  ...
  const handleCancelSale = useCallback(
    (tokenId: string) => {
      ...
      //   )
      // }
      setMessage('Buy and sell activities are not yet available at the moment.')
      setShowToast(true)
    },
