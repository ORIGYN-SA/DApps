# OGY Collections dApp

**OGY Collections dApp** is a decentralized application built to manage, trade, and interact with NFTs and governance. This dApp is part of a larger monorepo powered by Astro. It features three main sections:
...
- **Cancel a Sale**: Cancel your NFTs from the marketplace.
- **Transfer NFTs**: Transfer your NFTs to another wallet.
- **Transfer Tokens**: Transfer tokens to another wallet.

### 2. Library

- Integrated with **ICPSwap**, allowing easy access to data from tokens across the dApp.
